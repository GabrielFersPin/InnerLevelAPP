...
export function getClassTheme(characterClass: CharacterClass): {
  ...
  const themes = {
    strategist: {
      ...
      panel: "bg-blue-950/40 border-blue-400/30",
      text: "text-blue-100",
    ...
    warrior: {
      ...
      panel: "bg-red-950/40 border-amber-500/30",
      text: "text-red-100",
    ...
    creator: {
      ...
      panel: "bg-purple-950/40 border-purple-400/30",
    ...
    connector: {
      ...
      panel: "bg-green-950/40 border-emerald-400/30",
      text: "text-green-100",
    ...
    sage: {
      ...
      panel: "bg-amber-950/40 border-amber-300/30",
      text: "text-amber-100",
